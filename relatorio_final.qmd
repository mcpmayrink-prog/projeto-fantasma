...
uma variável quantitativa contínua, das lojas nos períodos entre 1880 e 1889. Os valores das receitas estão no intervalo [19.600, 21.500].
...
```
### Descritiva  
O gráfico mostra um ápice do ano de 1880, com uma média de aproximadamente 21.500,  e um mínimo em 1882, com aproximadamente 19.600. Ao longo dos anos há aumentos e quedas na média, no entanto nenhum ano passa a média de 1880, terminando a análise em 1889 com cerca de 20.250 de receita.


## Variação do Peso e Altura dos Clientes

### Introdução da Análise
O objetivo dessa análise é avaliar a variaçao peso por altura, que são variáveis quantitativas contínuas. O peso, eixo Y,está no intervalo [45,120] e a altura, eixo X, está no intervalo[150,200]. À medida que o peso aumenta, a altura também aumenta ou diminui?
...
### Descritiva
A dispersão do gráfico mostra que à medida que o peso aumenta, a altura também aumenta, visto que essa dispersão se comporta quase que linearmente.Isso também é visualizado no  resultado da correlação de Pearson, que mede a força(quanto mais perto de +1 ou -1 mais forte) e direção(se as duas aumentam ou dimunuem) da relação linear de duas variáveis, dessas variáveis. O resultado - 0,69 - indica que quando o peso ou altura aumentam, o outro aumentam também. Pelo quadros é possível perceber que suas médias são justamente onde o gráfico apresenta maior concentração de dados.
